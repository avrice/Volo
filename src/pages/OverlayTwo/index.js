  ...
  return (
    <>
      <Column className="bg-white_A700 font-nunito mx-[auto] lg:p-[28px] xl:p-[32px] 2xl:p-[36px] 3xl:p-[43px] w-[100%]">
        ...
        <Column className="items-center lg:mb-[62px] xl:mb-[71px] 2xl:mb-[80px] 3xl:mb-[96px] lg:ml-[45px] xl:ml-[51px] 2xl:ml-[58px] 3xl:ml-[69px] lg:mt-[47px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] lg:pr-[18px] xl:pr-[20px] 2xl:pr-[23px] 3xl:pr-[27px] w-[96%]">
